...
The app that talks to this lives in `../mobile`. It shares this side's error-code contract:
`ErrorCodes.java` and `mobile/src/platform/core/api/errors.ts` are a pair.
...
| [../mobile/README.md](../mobile/README.md) | The app that calls this |
